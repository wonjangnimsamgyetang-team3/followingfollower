...
const TodoDetail = ({
  ...
  return (
    <div>
      <div className="flex w-full h-full">
        <div className="flex flex-col justify-between w-1/2 mb-5 mr-10 mt-3 p-3">
          <section className="grow">
            ...
            <div className="relative w-[400px] h-1/2 mb-4 object-fit rounded-[30px]">
              {todo.imageFile ? (
                <Image
        ...
        <div className="h-[610px] border-solid border-l-2 border-subColor1">
          <ul className="flex flex-col px-8 w-[400px] h-full overflow-y-auto ">
            {commentData.map((comment) => (
              <li
                className="border-b-2 border-solid border-subColor2 p-4"
                key={comment.id}
